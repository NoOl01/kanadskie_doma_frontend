    ...
    return (
        <div className='about_root'>
            ...
            <div className="about_container_main_info_div">
                <div className="about_us_main_info_text">
                    ...
                    <p>Компания ООО «Канадские дома» основана в 2011 году. Наша компания работает в сегменте
                        ...
                        клиенты могут заказать как маленький садовый домик так и большой, красивый элитный дом, –
                        которые будут построены грамотно, качественно и в кратчайшие сроки. На все выполненные подряды
                        по строительству мы несем гарантийные обязательства согласно нашим договорам.</p>
                    <p>С нами удобно работать т.к. мы закрываем большой спектр оказываемых услуг в одном окне, начиная
                        от первичной консультации и выезда на участок для осмотра строй площадки, подъездных путей,
            ...
            <div className="about_us_principles_main_div">
                ...
                <div className="about_us_principles">
                    <p>Используем только качетсвенные и экологичные материалы</p>
            ...
            <div className="about_us_pluses_info_main_div">
                <div className="about_us_pluses_info_text_div">
                    ...
                    <p>Нашим заказчикам доступны наиболее выгодные и удобные предложения по финансированию строительства – ипотека Сбербанка, участие в жилищном кооперативе, льготная Сельская ипотека 2,7%, помогаем оформить кредит на строительство дома.</p>
