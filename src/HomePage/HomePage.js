    ...
    return (<div className="HomePage">
            ...
            <div className="about_us_main_div">
                <div className="about_us">
                    <h1>Мы компания «Канадские дома», мы работаем в сегменте малоэтажного строительства в
                        Калининградской области с физическими и юридическими лицами. Наши клиенты могут заказать как
                        маленький садовый домик, так и большой, красивый элитный дом, которые будут построены грамотно,
                        качественно и в кратчайшие сроки!</h1>
                </div>
